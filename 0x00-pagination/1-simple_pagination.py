...
function returns tuple of size two containing
start index and end index corresponding to the range of
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    """
    function returns tuple containing start index and an end index
    """
